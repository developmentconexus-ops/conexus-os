...
| Local platform delivery planning / L1–L6 | [approved delivery design](roadmap.md#approved-local-platform-delivery-design), [L1 local build/Preview](tasks/l1-local-build-preview.md), [L2 data/SDKs](tasks/l2-app-data-sdk.md), [L3 publication](tasks/l3-local-publication.md), [L4 integrations](tasks/l4-external-integrations.md), [L5 automations](tasks/l5-managed-automations.md), [L6 Brain/Builder knowledge](tasks/l6-brain-builder-knowledge.md) | Operator-approved platform-first local sequence; task files hold detailed plans, roadmap alone holds status/grants. Documentation planning is open; no code/live/publication grant and no R3 acceptance is implied |
| Execution board / R1–R7 map / package status / review routing | [`roadmap.md`](roadmap.md#execution-board) | Package IDs route work; semantic owners and proof packets remain authoritative |
| R3 package execution detail | [`tasks/r3.md`](tasks/r3.md), [`third-review stop adjudication`](evidence/4f/4f-r3-third-review-stop-root-cause-adjudication.md) | R3 is HOLD / REPLAN after the third-review stop; P1 readiness is withdrawn, the P2/P3/P4-A candidate is preserved but unaccepted, and runtime credential adoption, aggregate provenance, semantic ownership and P4-B remain explicit owner routes |
...
| BLD-10 Preview projection checkpoint and operator-directed roadmap planning | [`roadmap`](roadmap.md), [`decision register`](decisions/index.md#phase-4-accepted-refinements), [`current-subject decision packet`](evidence/4f/4f-bld-10-current-subject-owner-decision-packet.md), [`4C-F15 owner disposition`](evidence/4f/4f-bld-10-4c-f15-owner-disposition.md), [`stage code packet`](evidence/4f/4f-bld-10-preview-stage-code-packet.md), [`verification receipt`](evidence/4f/4f-bld-10-preview-verification-receipt.md), [`execution-goal record`](evidence/4f/4f-autonomous-roadmap-execution-goal.md), [`preparation packet`](evidence/4f/4f-preview-resumption-preparation.md), [`BLD-10 owner`](product/operation-ledger.md), [`Product Preview laws`](product/contract.md) | Projection mechanics and targeted proof are present; the omitted subject is anchored to the approved Baseline, the Goal is paused for operator-directed planning, and ready serving still waits for an accepted artifact producer |
