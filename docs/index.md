...
| Directed MVP consolidation / decision and proof tracking | [current tracking](roadmap.md#current-direction-and-tracking), [consolidation agreement](tasks/builder-first-app.md#directed-mvp-consolidation) | Start from the agreed smaller MVP; separate demonstrated behavior from proposals; implementation remains paused under the current documentation approval |
| First internal app / Builder design and practical proof | [first Builder app](tasks/builder-first-app.md) | Pilot design, fixed compiler preparation and bounded practical proof; current admission in roadmap |
| Deferred repository consolidation / document and check disposition | [consolidation map](tasks/repository-consolidation.md) | Retained migration proposal, not a prerequisite or the current work; no deletion or migration execution |
