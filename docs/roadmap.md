...
Deliver the ordinary internal coding agent through complete user journeys.
The operator approved the Builder-wide coherence review and this sequence on
2026-09-16. The goal is a usable Project application with contextual conversation,
real agent activity, exact source continuity, and a working last-good Preview.

The first increment is an operator pilot, not general employee rollout or a
complete business application platform. The final pilot acceptance still needs
the continuity and failure guarantees in the program.

Do not require a complete performance baseline, a Git rewrite, or a Preview
rewrite before implementing the minimum coherent user experience.

## Current state

| Work | Disposition |
| --- | --- |
| 7R-0 | CLOSED. Preserve its adopted native Mastra findings. |
...
The accepted initial 7R-1 implementation is
`3276f8fbf3ae8a38f6d0cab43fe540df221ebee9`.
The earlier 7R-2 delivery and its original contract remain available in Git.
Do not relabel partial measurements as complete proof.
