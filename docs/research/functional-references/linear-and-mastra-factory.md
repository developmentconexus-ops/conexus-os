...
| **Integrar Slack**: criar tarefa a partir de uma mensagem, notificações por canal, notificações pessoais (atribuição, menção, comentário) | Não | **Adotar como "Notificações", passo 6.** Para a `<empresa-1>`, provavelmente WhatsApp ou email antes do Slack. Confirmar o canal que a empresa usa | Passo 6 |
