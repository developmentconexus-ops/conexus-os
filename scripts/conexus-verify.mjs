...
export const CANDIDATE_GRAPH = Object.freeze([
  ...
  candidateStep('verification-tool-regressions', 'node --test --test-concurrency=1 tests/repository/import-law.test.mjs tests/repository/conexus-preflight.test.mjs tests/repository/conexus-verify.test.mjs'),
