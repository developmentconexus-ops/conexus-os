...
export const CANDIDATE_GRAPH = Object.freeze([
  candidateStep('a0-type-safety', 'npm run r1:a0:admission'),
  candidateStep('g0-profile-compiler', 'npm run r1:g0:verify'),
  candidateStep('r1-s2-generate', 'npm run r1:s2:check'),
  ...
  candidateStep('verification-tool-regressions', 'node --test --test-concurrency=1 tests/repository/conexus-preflight.test.mjs tests/repository/conexus-verify.test.mjs tests/repository/repository-contract.test.mjs tests/repository/architecture-verification.test.mjs'),
  candidateStep('hub-migration-selection', 'node --test tests/implementation/hub-migration-selection.test.mjs && npx --no-install biome check tests/implementation/hub-migration-selection.test.mjs tests/implementation/hub-migration-postgres.test.mjs'),
  ...
  candidateStep('hub-migration-postgres', 'node --test --test-concurrency=1 tests/implementation/hub-migration-postgres.test.mjs', 'postgres'),
  candidateStep('application-registry', 'node --test --test-concurrency=1 tests/implementation/builder-application-registry.test.mjs tests/implementation/builder-application-registry-postgres.test.mjs tests/implementation/builder-application-preparation-postgres.test.mjs', 'postgres'),
  ...
  candidateStep('r1-s3-git-identity', 'node scripts/generate-r1-s3-git-identity.mjs --check'),
  ...
  candidateStep('rb-first-source-checks', 'node --check scripts/run-hub-migrations.mjs && node --test --test-concurrency=1 tests/implementation/rb-builder-e2b-template.test.mjs tests/implementation/rb-builder-browser.test.mjs tests/implementation/builder-application-build.test.mjs tests/implementation/builder-application-runtime.test.mjs tests/implementation/builder-application-starter.test.mjs tests/implementation/builder-preview-preparation.test.mjs tests/implementation/builder-preview-http.test.mjs tests/implementation/builder-preview-access.test.mjs tests/implementation/builder-observation-contract.test.mjs tests/implementation/builder-runtime-observation.test.mjs tests/implementation/builder-observation-feed.test.mjs tests/implementation/builder-observation-http.test.mjs tests/implementation/builder-working-source-runtime.test.mjs tests/implementation/builder-pilot-service.test.mjs && npx --no-install biome check tests/implementation/builder-application-*.test.mjs tests/implementation/builder-preview-preparation.test.mjs tests/implementation/builder-preview-http.test.mjs tests/implementation/builder-preview-access.test.mjs tests/implementation/builder-working-source-runtime.test.mjs tests/implementation/builder-working-source-state.test.mjs tests/implementation/builder-pilot-service.test.mjs', 'browser'),
  candidateStep('rb-working-source-state', 'node --test --test-concurrency=1 tests/implementation/builder-working-source-state.test.mjs', 'postgres'),
