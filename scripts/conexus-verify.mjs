...
export const CANDIDATE_GRAPH = Object.freeze([
  ...
  candidateStep('repository-agent-context', 'node --test tests/repository/check-agent-context.test.mjs tests/repository/check-review-areas.test.mjs tests/repository/labels.test.mjs && npx --no-install biome check scripts/check-agent-context.mjs scripts/check-review-areas.mjs scripts/labels.mjs tests/repository/check-agent-context.test.mjs tests/repository/check-review-areas.test.mjs tests/repository/labels.test.mjs'),
