...
export const CANDIDATE_GRAPH = Object.freeze([
  ...
  candidateStep('application-data-postgres', 'node --test --test-concurrency=1 tests/implementation/application-data-postgres.test.mjs && npx --no-install biome check tests/implementation/application-data-postgres.test.mjs tests/implementation/application-cluster.mjs scripts/provision-application-database.mjs scripts/confine-application-cluster.mjs', 'postgres'),
  candidateStep('application-runner-sandbox', 'node --test --test-concurrency=1 tests/implementation/application-runner-sandbox.test.mjs && npx --no-install biome check tests/implementation/application-runner-sandbox.test.mjs tests/implementation/sandbox-probe/server-tree.mjs tests/implementation/sandbox-probe/pilot-probe.mjs apps/hub/src/app-runner', 'postgres'),
