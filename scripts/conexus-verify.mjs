...
export const CANDIDATE_GRAPH = Object.freeze([
  ...
  candidateStep('c020-mastra-lifecycle', 'node --test --test-concurrency=1 tests/implementation/builder-plan-starter.test.mjs tests/implementation/builder-mastra-session-routes.test.mjs qualification/4d/mastra-builder-capability/probe.test.mjs && npx --no-install biome check tests/implementation/builder-mastra-session-routes.test.mjs'),
  ...
  candidateStep('model-connection-share-postgres', 'node --test --test-concurrency=1 tests/implementation/model-connection-share-postgres.test.mjs', 'postgres'),
