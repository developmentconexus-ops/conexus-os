...
export const CANDIDATE_GRAPH = Object.freeze([
  ...
  candidateStep('c020-mastra-lifecycle', 'node --test --test-concurrency=1 tests/implementation/builder-session-projection.test.mjs tests/implementation/builder-plan-starter.test.mjs tests/implementation/builder-runtime-observation.test.mjs qualification/4d/mastra-builder-capability/probe.test.mjs'),
  ...
  candidateStep('c020-e2b-template', 'node scripts/builder-e2b-template.mjs --check && node --test --test-concurrency=1 tests/implementation/builder-e2b-template.test.mjs'),
  ...
  candidateStep('biome-current', 'npx --no-install biome check apps/hub/src apps/web/src packages/canonical-json/src packages/profile-compiler/src scripts/run-hub-migrations.mjs scripts/hub-catalog.mjs scripts/generate-hub-catalog-snapshot.mjs tests/implementation/builder-*.mjs tests/implementation/project-browser.test.mjs tests/repository/conexus-verify.test.mjs'),
  ...
  candidateStep('claude-account', 'node --test tests/implementation/claude-account.test.mjs'),
  candidateStep('claude-account-web-api', 'node --test tests/implementation/claude-account-web-api.test.mjs'),
