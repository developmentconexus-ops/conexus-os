...
export const CANDIDATE_GRAPH = Object.freeze([
  ...
  candidateStep('application-data-postgres', 'node --test --test-concurrency=1 tests/implementation/application-data-postgres.test.mjs && npx --no-install biome check tests/implementation/application-data-postgres.test.mjs scripts/provision-application-database.mjs', 'postgres'),
  candidateStep('application-runner-sandbox', 'node --test --test-concurrency=1 tests/implementation/application-runner-sandbox.test.mjs && npx --no-install biome check tests/implementation/application-runner-sandbox.test.mjs apps/hub/src/app-runner', 'postgres'),
