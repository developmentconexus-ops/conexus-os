...
export const CANDIDATE_GRAPH = Object.freeze([
  ...
  candidateStep('iam-installation-administrator', 'node --test --test-concurrency=1 tests/implementation/installation-administrator-postgres.test.mjs scripts/bootstrap-installation-administrator.mjs', 'postgres'),
  ...
  candidateStep('repository-agent-context', 'node --test tests/repository/check-agent-context.test.mjs tests/repository/labels.test.mjs tests/repository/conexus-verify.test.mjs tests/repository/verify-gates.test.mjs tests/repository/worktree-reap.test.mjs'),
