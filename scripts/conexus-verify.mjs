...
export const CANDIDATE_GRAPH = Object.freeze([
  ...
  candidateStep('connector-broker', 'node --test tests/implementation/connector-token-cache.test.mjs tests/implementation/connector-broker.test.mjs tests/implementation/connector-adapter-source.test.mjs && npx --no-install biome check tests/implementation/connector-token-cache.test.mjs tests/implementation/connector-broker.test.mjs tests/implementation/connector-adapter-source.test.mjs tests/implementation/connector-fake-gateway.mjs apps/hub/src/connectors'),
