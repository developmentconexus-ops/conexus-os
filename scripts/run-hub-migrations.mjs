...
const assert015Catalog = async (
  ...
  { after016 = false, after017 = false, after018 = false, after019 = false, after020 = false } = {},
) => {
...
const assert019Catalog = async (client, { after020 = false, after021 = false, after022 = false, after023 = false } = {}) => {
