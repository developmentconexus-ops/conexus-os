...
const ROLE_BY_CALL_SITE = Object.freeze({
  'builder/store.ts': Object.freeze({
    'builder.create_builder_run_with_model': 'hub_rb_ingress',
    'builder.create_builder_run': 'hub_rb_ingress',
    'builder.read_builder_run': 'hub_rb_ingress',
    'builder.list_builder_runs': 'hub_rb_ingress',
    'builder.read_latest_code_changing_builder_run': 'hub_rb_ingress',
    'builder.request_builder_run_cancellation': 'hub_rb_ingress',
    'builder.read_preview_subject': 'hub_rb_ingress',
    'builder.admit_source_revision': 'hub_rb_ingress',
    'builder.claim_builder_run': 'hub_rb_executor',
    'builder.set_builder_run_phase': 'hub_rb_executor',
    'builder.bind_builder_run_message': 'hub_rb_executor',
    'builder.bind_builder_run_sandbox': 'hub_rb_executor',
    'builder.settle_builder_run': 'hub_rb_executor',
    'builder.advance_builder_run_source': 'hub_rb_executor',
    'builder.settle_builder_run_build': 'hub_rb_executor',
    'builder.fail_builder_run': 'hub_rb_executor',
    'builder.interrupt_builder_run': 'hub_rb_executor',
    'builder.recover_builder_runs': 'hub_rb_executor',
  }),
  ...
  'model-connection-account/module.ts': Object.freeze({
    ...
    'model_connection.read_current_generation': 'hub_r2_connections',
    'model_connection.advance_generation': 'hub_r2_connections',
  }),
  'model-connection-account/store.ts': Object.freeze({
    'model_connection.start_authorization': 'hub_r2_connections',
    'model_connection.consume_authorization': 'hub_r2_connections',
    'model_connection.publish_connection': 'hub_r2_connections',
    'model_connection.complete_authorization': 'hub_r2_connections',
    'model_connection.list_connections': 'hub_r2_connections',
    'model_connection.fail_authorization': 'hub_r2_connections',
    'model_connection.select_connection': 'hub_r2_connections',
    'model_connection.share_connection': 'hub_r2_connections',
    'model_connection.unshare_connection': 'hub_r2_connections',
    'model_connection.revoke_connection': 'hub_r2_connections',
    'model_connection.admit_for_project': 'hub_r2_connections',
  }),
  'project/store.ts': Object.freeze({
    'project.list_project_summaries': 'hub_s3_read',
    'project.get_project': 'hub_s3_read',
    'project.claim_abandoned_create_project_attempt': 'hub_prj03_command',
    'project.reserve_or_replay_create_project': 'hub_prj03_command',
    'project.lock_create_project_receipt': 'hub_prj03_command',
    'project.create_project_with_source': 'hub_prj03_command',
    'project.complete_create_project_receipt': 'hub_prj03_command',
  }),
  'registry/application-artifact-store.ts': Object.freeze({
    'reg.retain_application_execution': 'hub_rb_executor',
    'reg.get_application_by_source': 'hub_rb_executor',
    'reg.read_application_file_by_source': 'hub_rb_executor',
  }),
  'workspace/store.ts': Object.freeze({
    'workspace.reserve_or_replay_create_workspace': 'hub_ws01_command',
    'workspace.create_workspace': 'hub_ws01_command',
    'workspace.complete_create_workspace_receipt': 'hub_ws01_command',
    'workspace.get_workspace_summary': 'hub_s2_read',
  }),
})
