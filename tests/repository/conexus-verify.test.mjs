...
const EXPECTED_CANDIDATE_SCOPES = Object.freeze([
  ...
  'c020-builder-postgres', 'c020-builder-request-text-postgres', 'c020-mastra-lifecycle',
  ...
  'model-connection-credentials', 'model-connection-dispatch', 'model-connection-anthropic-oauth',
  'model-connection-openai-codex', 'model-connection-http', 'model-connection-share-postgres',
  'model-connection-web-api', 'model-offers', 'model-offers-postgres',
