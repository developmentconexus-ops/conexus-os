...
const EXPECTED_CANDIDATE_SCOPES = Object.freeze([
  ...
  'c020-builder-postgres', 'c020-builder-request-text-postgres', 'factory-binding-postgres', 'c020-mastra-lifecycle', 'factory-dependency-tree', 'factory-composition', 'factory-routes', 'factory-provisioning',
