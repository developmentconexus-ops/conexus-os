...
const EXPECTED_CANDIDATE_SCOPES = Object.freeze([
  ...
  'model-connection-credentials', 'model-connection-dispatch', 'model-connection-anthropic-oauth', 'model-connection-openai-codex',
  'model-connection-http', 'model-connection-web-api', 'model-offers', 'model-offers-postgres',
