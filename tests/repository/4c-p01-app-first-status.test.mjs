...
test('P-01 app-first falsifier remains preserved through later approved P8 refinement and lock',()=>{
  ...
  assert.doesNotMatch(roadmap,/P-02\+?\s*=\s*OPEN|P11\s*=\s*ASSEMBLED|4D\s*=\s*OPEN/,'later P-01 refinement/lock must not open later blocks')
})
