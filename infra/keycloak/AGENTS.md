...
No script checks this directory. Before you commit the realm export, confirm every secret field still holds its placeholder. For the theme the install script ships:
