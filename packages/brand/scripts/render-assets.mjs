// Renders the PNG exports in packages/brand/assets/ from the SVG sources in the same directory,
// using the Playwright Chromium already vendored for the repo's browser test suites. Rerun this
// after any change to mark.svg, mark-dark.svg, lockup-light.svg or lockup-dark.svg.
