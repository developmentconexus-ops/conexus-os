...
const CATEGORY_BY_CODE: Readonly<Record<string, BuilderFailureCategory>> = Object.freeze({
  ...
  APPLICATION_SMOKE_TIMEOUT: 'APPLICATION_BUILD_FAILED',
  APPLICATION_SMOKE_NO_ROOT_CHILD: 'APPLICATION_BUILD_FAILED',
  APPLICATION_SMOKE_UNCAUGHT_ERROR: 'APPLICATION_BUILD_FAILED',
  APPLICATION_SMOKE_DEVTOOLS_UNAVAILABLE: 'APPLICATION_BUILD_FAILED',
  APPLICATION_SMOKE_CDP_CONNECT_FAILED: 'APPLICATION_BUILD_FAILED',
  APPLICATION_SMOKE_CHROMIUM_UNAVAILABLE: 'APPLICATION_BUILD_FAILED',
  APPLICATION_SMOKE_VERDICT_UNREADABLE: 'APPLICATION_BUILD_FAILED',
