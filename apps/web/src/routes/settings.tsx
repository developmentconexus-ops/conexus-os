...
function SettingsRoute() {
  ...
  return <Shell context={access.data}><main className="control-plane-page"><div className="page-heading"><div><p className="eyebrow">Conta</p><h1>Configurações</h1></div></div><ModelConnectionSettings workspaces={access.data.workspaces} currentAccountId={access.data.account.accountId} /></main></Shell>
}
